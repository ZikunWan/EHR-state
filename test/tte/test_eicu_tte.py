...
def build_dataset(args, path, limit, max_bins):
    base = EICUDataset(root_dir=args.data_dir, processed_dir=args.processed_dir, sample_info_path=path, task_name=args.task_name, lazy_mode=True, shuffle=False, max_samples=limit)
